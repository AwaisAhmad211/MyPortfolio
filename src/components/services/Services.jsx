  ...
  return (
    <motion.div ref={ref} className='services' variants={variants} initial="initial" animate="animate" >
        ...
        <div className="listContainer">
            <motion.div className="box" initial={{y : 100}} whileInView={{y : 1,transition:{duration : 0.5}}} whileHover={{backgroundColor:"#ffffff15"}}>
            ...
            <motion.div className="box" initial={{y : 50}} whileInView={{y : 1,transition:{duration : 0.5}}} whileHover={{backgroundColor:"#ffffff15"}}>
